...
downButton === null || downButton === void 0 ? void 0 : downButton.addEventListener("click", () => {
    count -= 1;
    if ((number === null || number === void 0 ? void 0 : number.textContent) == null || number.textContent == "") { //I always had to eliminate the possibility of number being null || undefined
        return;
    }
...
resetButton === null || resetButton === void 0 ? void 0 : resetButton.addEventListener("click", () => {
    count = 0;
    if ((number === null || number === void 0 ? void 0 : number.textContent) == null || number.textContent == "") {
        return;
    }
    number.textContent = count.toString();
...
upButton === null || upButton === void 0 ? void 0 : upButton.addEventListener("click", (e) => {
    count += 1;
    if ((number === null || number === void 0 ? void 0 : number.textContent) == null || number.textContent == "")
        return;
    number.textContent = count.toString();
...
function colourCheck() {
    if ((number === null || number === void 0 ? void 0 : number.textContent) == null || (number === null || number === void 0 ? void 0 : number.textContent) == "") {
        return;
    }
